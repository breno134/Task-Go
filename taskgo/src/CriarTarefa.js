function CriarTarefa({eventoTeclado, criarTarefa, modo, obj}) {
    ...
    return (
        ...
        <form>
            <div className="container bg-white border-rounded text-center margin-6px">
            <h1 className="text text-center">Organize suas tarefas de forma fácil com o Task Go!</h1>
                ...
                <input type='date' value={obj.prazo} onChange={eventoTeclado} name="prazo" placeholder="Prazo" className="form-control"/>
